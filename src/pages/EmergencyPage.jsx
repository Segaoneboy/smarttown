...
function EmergencyServices() {
    const services = [
        { name: 'Полиция', phone: '+102', bgColor: 'bg-blue-500', hoverColor: 'hover:bg-blue-600' },
        { name: 'Скорая помощь', phone: '+103', bgColor: 'bg-green-500', hoverColor: 'hover:bg-green-600' },
        { name: 'Пожарные', phone: '+101', bgColor: 'bg-red-500', hoverColor: 'hover:bg-red-600' }
    ];
